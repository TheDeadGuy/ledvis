...
LED_1_DMA        = 4      # DMA channel to use for generating signal (Between 1 and 14)
...
LED_2_DMA        = 4      # DMA channel to use for generating signal (Between 1 and 14)
